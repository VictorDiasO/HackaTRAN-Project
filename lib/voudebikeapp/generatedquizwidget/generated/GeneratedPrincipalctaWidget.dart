...
import 'package:flutterapp/voudebikeapp/generatedquizwidget/generated/GeneratedComearWidget.dart';
import 'package:flutterapp/helpers/transform/transform.dart';
import 'package:flutterapp/voudebikeapp/generatedquizwidget/generated/GeneratedBackgroundWidget.dart';

/* Frame Principal cta
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedPrincipalctaWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(context, '/GeneratedQuizWidget2'),
      child: Container(
        width: 161.0,
        height: 45.0,
